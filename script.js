...
function handleKeyboardShortcuts(e) {
  ...
  switch(e.key.toLowerCase()) {
    case 'enter':
      ...
      break;
    case 'f':
      if (state.currentJoke) toggleFavorite();
      break;
    case 'c':
      if (state.currentJoke) copyJoke();
      break;
    case 's':
      if (state.currentJoke) shareJoke();
      break;
    case 't':
...
function toggleFavorite() {
  ...
  const index = state.favorites.findIndex(f => f.id === state.currentJoke.id);
